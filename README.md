...
### FEARec + MultiIntentExtractor

Use `FEARec_MI` (or the alias `MOE_FEARec`) and optionally set the number of
latent interests. Training logs contain the epoch loss, User0's intent fusion
distribution, and validation/test HR@5, HR@10, NDCG@5, and NDCG@10.

```
python main.py --model_type FEARec_MI \
               --data_name Beauty \
               --num_intents 4 \
